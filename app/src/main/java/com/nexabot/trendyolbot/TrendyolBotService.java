        ...
        webView.evaluateJavascript(targetSearchScript, result -> {
            ...
            if (cleanResult.startsWith("FOUND:")) {
                ...
                mainHandler.postDelayed(() -> {
                    ...
                    mainHandler.postDelayed(() -> {
                        String nextPageNumber = Integer.toString(currentPage + 1);
                        String nextPageScript =
                                ...
                                "    if (text === '" + nextPageNumber + "' && link.offsetParent !== null) {" +
                                "      nextPageLink = link;" +
                                "      break;" +
                                "    }" +
                                "  }" +
                                ...
                                "      if ((text === 'sonraki' || text === 'next') && link.offsetParent !== null) {" +
                                "        nextPageLink = link;" +
                                "        break;" +
                                "      }" +
                                "    }" +
                                "  }" +
                                "  if (nextPageLink) {" +
                                "    nextPageLink.style.border = '5px solid blue';" +
                                "    nextPageLink.style.backgroundColor = 'lightblue';" +
